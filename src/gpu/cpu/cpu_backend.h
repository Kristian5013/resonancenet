...
/// CPU fallback backend — implements all kernel ops with basic CPU loops.
/// Used when no GPU is available (testing/development).
class CpuFallbackBackend final : public GpuBackend {
public:
    CpuFallbackBackend();
